// Modules
include { COMET_SERIAL } from "../modules/comet"
...
workflow wf_comet_percolator {
    ...
    main:
        ...
        COMET_SERIAL(mzml_files, new_comet_params, fasta)

        FILTER_PIN(COMET_SERIAL.out.pin)
        ...
        CONVERT_TO_LIMELIGHT_XML(COMET_SERIAL.out.pepxml, PERCOLATOR.out.pout, fasta, new_comet_params, params.limelight_xml_conversion_java_params)
