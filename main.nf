...
workflow {
    ...
    CONVERT_TO_LIMELIGHT_XML(COMET_MULTIPLE_FILES_SEQUENTIALLY.out.pepxml, PERCOLATOR.out.pout, fasta, new_comet_params, params.limelight_xml_conversion_java_params)
